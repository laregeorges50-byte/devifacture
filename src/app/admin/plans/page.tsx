  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500 mt-2 text-lg">Passez au niveau supérieur pour débloquer la création de documents illimités.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch">
        ...
        <div className="p-8 rounded-3xl bg-white border border-gray-200 shadow-sm flex flex-col items-center text-center">
          ...
          <ul className="space-y-4 text-sm text-gray-600 flex-1 w-full text-left">
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-blue-500 shrink-0" /> 20 documents par mois</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-blue-500 shrink-0" /> Modèles de base</li>
        ...
        <div className="relative p-8 rounded-3xl bg-blue-600 text-white shadow-xl shadow-blue-900/20 border border-blue-500 flex flex-col items-center text-center transform lg:-translate-y-4">
          ...
          <div className="mb-6">
            ...
            <span className="text-blue-200 font-medium"> / mois</span>
          </div>
          ...
          <ul className="space-y-4 text-sm text-blue-50 flex-1 w-full text-left">
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-blue-300 shrink-0" /> 80 documents par mois</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-blue-300 shrink-0" /> Personnalisation avancée</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-blue-300 shrink-0" /> Statistiques de base</li>
          </ul>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white border border-gray-200 shadow-sm flex flex-col items-center text-center">
          ...
          <ul className="space-y-4 text-sm text-gray-600 flex-1 w-full text-left">
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-gray-900 shrink-0" /> Documents illimités</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={18} className="text-gray-900 shrink-0" /> Plusieurs utilisateurs</li>
